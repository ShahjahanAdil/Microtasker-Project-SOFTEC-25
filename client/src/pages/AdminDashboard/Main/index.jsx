    ...
    return (
        <div className='dashboard-container'>
            <div className="inner-container">
                ...
                <h1 className='!text-[30px] !text-[#5271ff] mb-5 mt-5 pb-2 flex items-center gap-2 border-b-2 border-gray-200'><FaTrophy /> Top Performers</h1>
                <div className='flex gap-5 w-full h-[350px] mt-10'>
                    <div className='top-box-1 box-shadow px-[30px] py-[20px] rounded-[15px] relative flex-1'>
                        ...
                        <p className='grad absolute left-[30px] bottom-[20px] !text-[#fff] bg-[#666] px-3 rounded-[5px]'>Points: {topUsers[0]?.points.toFixed(2)}</p>
                    ...
                    <div className='flex flex-col flex-1 gap-5'>
                        <div className='top-box-2 box-shadow px-[30px] py-[20px] rounded-[15px] relative flex-1 h-full'>
                            ...
                            <p className='grad absolute left-[30px] bottom-[20px] !text-[#fff] text-[16px] bg-[#666] px-3 rounded-[5px]'>Points: {topUsers[1]?.points.toFixed(2)}</p>
                        ...
                        <div className='top-box-3 box-shadow px-[30px] py-[20px] rounded-[15px] relative flex-1 h-full'>
                            ...
                            <p className='grad absolute left-[30px] bottom-[20px] !text-[#fff] text-[16px] bg-[#666] px-3 rounded-[5px]'>Points: {topUsers[2]?.points.toFixed(2)}</p>
