...
export default function FailedTasks() {
    ...
    const handleFetchData = () => {
        setLoading(true)
        axios.get(`${import.meta.env.VITE_HOST}/user/failed-tasks?userID=${user?.userID}`)
            .then(res => {
                ...
                <div className='p-3 rounded-[5px]'>
                    <h6 className='font-bold text-[20px] text-[#333] flex items-center gap-2'>
                        <p className='flex items-center gap-2'>
                            ...
                            <span className='text-[18px] font-normal text-[#666]'>/ Failed Tasks</span>
                        </p>
                    </h6>
                </div>
                                ...
                                <table className="min-w-full divide-y divide-gray-200">
                                    <thead className='bg-[#5272ffa3]'>
                                        <tr>
                                            ...
                                            <th scope="col" className="px-6 py-3 text-start text-[13px] font-bold text-[#fff] uppercase whitespace-nowrap">Rejected On</th>
